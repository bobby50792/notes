...
$$
\begin{align*}
\vec{v} = \frac{d\vec{r}}{dt} = \frac{d}{dt}r(t)\hat{r} = \dot{r}\hat{r} + r\dot{\theta}\hat{\theta} 
\end{align*}
$$
...
$$
\begin{align*}
\vec{v} = \frac{r d\theta}{dt}\hat{\theta} = \vec{\omega} \times \vec{r},
\end{align*}
$$

$$
\begin{align*}
\vec{\omega} = \frac{d\theta}{dt}\hat{z} = \omega\hat{z}.
\end{align*}
$$
