...
Observation: Let $V$ and $W$ be vector spaces and $T : V \to W$ be linear.  Then $N(T)$ and $R(T)$ are subspaces of $V$ and $W$, respectively.
...
1. Let $V$ and $W$ be vector spaces, and let $T : V \to W$ be linear.  If $\beta = \{v_1, v_2, \ldots, v_n\}$ is a basis for $V$, then
...
5. Let $V$ and $W$ be finite-dimensional vector spaces having ordered bases  $\beta$ and $\gamma$, respectively, and let $T : V \to W$ be linear.  Then, for each $u \in V$, we have
...
1. Let $V$ and $W$ be finite-dimensional vector spaces of dimensions $n$ and $m$, respectively. Then $\mathcal{L}(V, W)$ is finite-dimensional of dimension $mn$.
